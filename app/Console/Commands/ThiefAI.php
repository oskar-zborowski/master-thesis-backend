                ...
                if ($thief->hidden_position !== null) {
                    ...
                    if (isset($destinationsConfirmed[$thief->id])) {
                        ...
                        foreach ($destinationsConfirmed[$thief->id] as &$destinationConfirmed9) {
                            ...
                            $safeRoadCoefficient = 0.6;
                            $safeDestinationCoefficient = 0.4;
                            ...
                            $safeDestination = 0.1 * $destinationConfirmed9['disclosureDistanceCoefficient'] + 0.2 * $destinationConfirmed9['distanceToCenterCoefficient'] + 0.3 * $destinationConfirmed9['maxDistanceCoefficient'] + 0.4 * $destinationConfirmed9['lastDisclosureDistanceCoefficient'];
