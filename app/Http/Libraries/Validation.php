...
class Validation
{
    ...
    public static function room_updateRoom() {
        return [
            ...
            'actor_saboteur_show_number' => 'nullable|boolean',
            'game_duration_scheduled' => 'nullable|integer|between:300,14400',
            'game_duration_escape_time' => 'nullable|integer|between:60,1800',
            'catching_number' => 'nullable|integer|between:1,5',
            'catching_radius' => 'nullable|integer|between:50,1000',
            'catching_time' => 'nullable|integer|between:0,60',
            'catching_uninterrupted' => 'nullable|boolean',
            ...
            'disclosure_while_completing_mission' => 'nullable|boolean',
            'disclosure_after_crossing_border' => 'nullable|boolean',
            'mission_number' => 'nullable|integer|between:3,50',
            'mission_radius' => 'nullable|integer|between:50,500',
            'mission_time' => 'nullable|integer|between:0,60',
            'mission_all_visible' => 'nullable|boolean',
            'monitoring_number' => 'nullable|integer|between:0,10',
            'monitoring_radius' => 'nullable|integer|between:50,1000',
            'monitoring_central_number' => 'nullable|integer|between:0,5',
            'monitoring_central_radius' => 'nullable|integer|between:50,1000',
            ...
            'other_crossing_border_countdown' => 'nullable|integer|between:-1,60',
