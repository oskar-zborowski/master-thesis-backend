...
class UpdateRoomRequest extends FormRequest
{
    ...
    public function rules() {
        return [
            ...
            'policeman_number' => 'nullable|integer|between:1,15',
            'thief_number' => 'nullable|integer|between:1,5',
            'agent_number' => 'nullable|integer|between:0,3',
            'saboteur_number' => 'nullable|integer|between:0,3',
            'saboteur_probability' => 'nullable|numeric|between:0,1',
            ...
            'game_duration_scheduled' => 'nullable|integer|between:300,10800',
            'escape_time' => 'nullable|integer|between:30,1800',
            'catching_number' => 'nullable|integer|between:1,3',
            'catching_radius' => 'nullable|integer|between:10,100',
            'catching_time' => 'nullable|integer|between:1,10',
            'disclosure_interval' => 'nullable|integer|between:60,900',
            ...
            'monitoring_number' => 'nullable|integer|between:3,10',
            'monitoring_radius' => 'nullable|integer|between:10,100',
            'monitoring_central_number' => 'nullable|integer|between:1,5',
            'monitoring_central_radius' => 'nullable|integer|between:10,100',
            'mission_number' => 'nullable|integer|between:3,30',
            'mission_radius' => 'nullable|integer|between:10,100',
            'mission_time' => 'nullable|integer|between:3,60',
            ...
            'fake_position_radius' => 'nullable|integer|between:100,1000',
            ...
            'boundary' => 'nullable|array|between:3,20',
            'mission_centers' => 'nullable|array|between:3,30',
            'monitoring_centers' => 'nullable|array|between:3,10',
