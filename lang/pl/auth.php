...
return [
    ...
    */
    ...
    'invalid-refresh-token-format' => 'Zły format refresh tokena. Należy umieścić go wyłącznie w nagłówku żądania jako ciąg znaków.',
    'invalid-token' => 'Nieprawidłowy token.',
    'invalid-token-format' => 'Zły format tokena. Należy umieścić go wyłącznie w nagłówku żądania jako ciąg znaków.',
